...
const About = () => {
  ...
  useEffect(() => {
    SetsectionChange((prev) => ({ ...prev, about: isInView }));
  }, [isInView]);
  return (
    <motion.section
      className="about"
        ...
        <div className="wrapper">
          ...
          <div className="title">
            ...
            >
              ...
              energy for all Goal 7 is about ensuring access to clean and
              affordable energy, which is key to the development of agriculture,
              business, communications, education, healthcare and
              transportation.
            </motion.p>
            <motion.a
              initial={{ x: -20, opacity: 0 }}
